...
// src/footer.ts
var SPLASH_VERSION_LINE = "SUMOCODE V0.3.0 \xB7 CATHEDRAL \xB7 160 \xD7 45 MONOSPACE";
var RESET = "\x1B[0m";
...
var herdrTerminalHost = {
  ...
  async sendPaneText(pi, pane, text) {
    try {
      const prompted = await pi.exec("herdr", ["agent", "prompt", pane.paneId, text], { timeout: 5e3 });
