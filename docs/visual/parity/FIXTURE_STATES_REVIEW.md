...
Plan 081 keeps both Activity-card Bible targets as fixed, independently authored HTML scenes; the Bible generator does not import or invoke the fixture capture renderer. The deterministic fixture is aligned to those targets. Landscape and portrait each report `Styled cell diff: MATCH`, pass geometry audit, and produce zero pixel-diff ratio for full/chat-area crops. No golden was promoted.
