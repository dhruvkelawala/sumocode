...
for required in bin/sumocode bin/sumocode-pi extension/sumocode-extension.bundle.mjs extension/sumocode-rpc-extension.bundle.mjs share/yoga.wasm share/sumo-face.ans CHANGELOG.md; do
