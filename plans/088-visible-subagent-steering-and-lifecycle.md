# Plan 088: Steerable visible subagents with silence-based lifecycle and graceful close
...
- `src/sumo-tui/rpc/prompt-scheduler.ts` and the host FIFO — that is plan 089.
...
- [ ] Plan 088 row updated in `plans/README.md`
...
- Plan 089 (native Pi queue) changes how *typed* input queues in the child's
