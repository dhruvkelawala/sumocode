...
- **Effort**: L
- **Risk**: LOW
- **Depends on**: `plans/094-truthful-command-readiness.md`, `plans/101-pi-version-compatibility-matrix.md`, plus the final-wave gate covering every accepted non-deferred Plan 091–114 row (Plan 105 rejected; Plan 110 deferred outside the campaign)
- **Category**: docs
...
- [ ] Every accepted non-deferred Plan 091–114 row was `DONE` before documentation edits began (Plan 105 rejected; Plan 110 deferred outside the campaign).
...
- Plan 094 or 101 is not complete, any other accepted non-deferred Plan 091–114 row is unfinished (Plan 105 rejected and Plan 110 deferred outside the campaign do not block), or current readiness/version facts cannot be stated.
