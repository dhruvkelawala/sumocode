...
| 104 | [Terminal delivery recovery E2E](104-terminal-delivery-end-to-end-recovery.md) | P1 | L | M3 | 092, 093, 100 | DONE locally — `5390a356`; review repairs add verified crash cleanup for held terminal trees, the full deferred-index replay/ack/redaction contract, and expected-crash evidence classification; production sources unchanged; typecheck/build/lint green, focused real-process rerun deferred for coordinated execution | [#398](https://github.com/dhruvkelawala/sumocode/issues/398) |
