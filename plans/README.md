...
| 092 | [Credential-safe PTY harness — sanitized public brief](issues/092.md) | P0 | M | M1 | — | DONE — `d7d2390`; 19/19 focused; 2,514/2,514 unit (2 workers); 111/111 integration; typecheck/build/lint green; CI pending | [#386](https://github.com/dhruvkelawala/sumocode/issues/386) |
