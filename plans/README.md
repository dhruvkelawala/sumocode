...
| 102 | [Remediate dependency advisories — sanitized public brief](issues/102.md) | P1 | M | M2 | 101 | DONE locally — aligned Pi peer/dev minimum raised to the fixed 0.84.4 release; local graph highs removed with narrow Pi/Vite transitive overrides and no audit exceptions remain; audit policy CLI rejects unclassified, stale, expired, mismatched, local-path, duplicate, and unremediated records and runs in CI; focused 17/17, unit 3,044/3,044, integration 190/190 with zero orphans, supported Pi 0.84.4 matrix, native build + contract 46/46, typecheck/build/lint green | [#396](https://github.com/dhruvkelawala/sumocode/issues/396) |
...
| 110 | [Effect `SubagentManager` pilot](110-effect-subagent-manager-pilot.md) | P2 | L | M4 | 109 | SUPERSEDED by 118 — production adoption is planned in [118](118-effect-v4-refactor-campaign.md); the Step 2 contract matrix is reused as the Wave 2 oracle | [#404](https://github.com/dhruvkelawala/sumocode/issues/404) |
...
3. **M4 lifecycle/Effect:** Plan 110 remains a contained non-production spike required for campaign closure; it does not authorize Effect adoption. Plan 111 follows Plan 104 and must preserve Plan 117's native launcher/child contracts.
