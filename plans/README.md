...
| 102 | [Remediate dependency advisories — sanitized public brief](issues/102.md) | P1 | M | M2 | 101 | READY — Plan 101 is complete; before dispatch, reconcile the private executor plan with Plan 117's Bun pin, package scripts, and release workflow without publishing private security evidence | [#396](https://github.com/dhruvkelawala/sumocode/issues/396) |
