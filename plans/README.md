...
| 068 | [plans/068-herdr-native-visible-subagents.md](068-herdr-native-visible-subagents.md) | Herdr-native visible subagents: `subagent_spawn {visible:true}` → real sumocode panes tiled in a "subagents" tab or worktree workspaces; `subagent_send` steering; herdr sidebar is the fleet UI (in-app dashboard retired) | P1 | L | [#306](https://github.com/dhruvkelawala/sumocode/issues/306) | TODO — reshaped 2026-07-19 (research: docs/research/HERDR_VISIBLE_SUBAGENTS_2026.md); ready to dispatch after operator review |
