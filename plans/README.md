...
| 099 | [Bound child protocol buffers — sanitized public brief](issues/099.md) | P1 | M | M2 | — | DONE — shared byte-bounded JSONL decoder, marked stderr tails, retained-result caps, and boundary/lifecycle tests | [#393](https://github.com/dhruvkelawala/sumocode/issues/393) |
