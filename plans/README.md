...
| 108 | [Preserve child executable provenance](108-preserve-child-executable-provenance.md) | P1 | M | M3 | 095, 097, 101 | READY NEXT — reconciled at `9ef92fa1` for Plan 117's native `PI_BIN`/`SUMOCODE_LAUNCHER`, compiled-child contract, and generated-artifact policy | [#402](https://github.com/dhruvkelawala/sumocode/issues/402) |
