...
| 094 | [Truthful command readiness](094-truthful-command-readiness.md) | P0 | M | M1 | 093 | DONE locally — exact code head `d96ea75`; truthful editor/command readiness and queued-submit behavior implemented; prior source-equivalent gates green, final exact-head review/verification and publication CI pending | [#388](https://github.com/dhruvkelawala/sumocode/issues/388) |
