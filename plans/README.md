...
| 101 | [Pi compatibility matrix](101-pi-version-compatibility-matrix.md) | P1 | M | M3 | 092, 096 | DONE locally — rebased onto PR #429 `4f79b14`; supported patches 0.84.3 + 0.84.4 green with production-source typechecks against each candidate's RPC shapes; contract fixtures 12/12; default-parallel unit 2,754/2,754; typecheck/build/lint green; CI pending | [#395](https://github.com/dhruvkelawala/sumocode/issues/395) |
