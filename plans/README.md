...
| 070 | [Migration: retire bg_task + routing guidance](070-orchestration-migration.md) | P3 | M | 065–069 + operator gate | [#308](https://github.com/dhruvkelawala/sumocode/issues/308) | IN PROGRESS — gate CONFIRMED (operator dogfooded 7 visible children, 2 rounds, clean); + baseRef param & dispatch-recipe guideline folded in; executor on advisor/070-orchestration-migration |
