...
| 101 | [Pi compatibility matrix](101-pi-version-compatibility-matrix.md) | P1 | M | M3 | 092, 096 | DONE locally — rebased onto PR #428 `f50797b`; supported patches 0.84.3 + 0.84.4 green; contract fixtures 12/12; default-parallel unit 2,751/2,751; typecheck/build/lint green; committed extension bundle rebuilt; CI pending | [#395](https://github.com/dhruvkelawala/sumocode/issues/395) |
