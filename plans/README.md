...
| 093 | [Indexed terminal-store startup](093-index-terminal-store-startup.md) | P0 | L | M1 | 091, 092 | REVIEWING — restacked commits `5f4476f`, `a61e689`, `6450208`; 82/82 focused (serial); 2,538/2,538 unit (one worker); typecheck/build/lint green; extension bundle rebuilt from combined source with no drift; integration 111/111 pre-restack, while the post-restack full local lane repeatedly load-saturated at 98/111 across untouched boot tests (tight regressions pass: rpc-tree 4/4 and rpc-activity 10/10 in isolation); clean CI required before DONE | [#387](https://github.com/dhruvkelawala/sumocode/issues/387) |
