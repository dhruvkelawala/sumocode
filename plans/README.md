...
| 093 | [Indexed terminal-store startup](093-index-terminal-store-startup.md) | P0 | L | M1 | 091, 092 | DONE (provisional; restack required) — `caaae28`; 82/82 focused; 2,531/2,531 unit (one worker); default parallel 2,527/2,531 from unrelated load-sensitive flakes (66/66 host-actions and 22/22 visual parity isolated); 111/111 integration; typecheck/build/lint green; extension bundle rebuilt with zero post-integration drift; CI pending | [#387](https://github.com/dhruvkelawala/sumocode/issues/387) |
