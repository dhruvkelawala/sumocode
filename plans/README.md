...
| 093 | [Indexed terminal-store startup](093-index-terminal-store-startup.md) | P0 | L | M1 | 091, 092 | DONE (provisional; restack required) — `caaae28`, `e8c974d`; 82/82 focused (serial); 2,531/2,531 unit (one worker); default parallel 2,509/2,531 from unrelated load-sensitive timeouts/perf flakes; 111/111 integration; typecheck/build/lint green; extension bundle rebuilt with zero post-integration drift; CI pending | [#387](https://github.com/dhruvkelawala/sumocode/issues/387) |
