...
| 095 | [Honest, settlement-aware visible steering ACKs](095-truthful-visible-steering-acks.md) | P1 | M | M1 | 092 | DONE — `3df8c7b`, review fixes `18b35b4`; 162/162 focused; 111/111 integration; typecheck/build/lint green; bundle rebuilt; full unit 2,522/2,523 best (2 workers) — the miss is a pre-existing load-timing flake in unrelated host-actions (20ms flushIO waits), repro at base HEAD and green in isolation; CI pending | [#389](https://github.com/dhruvkelawala/sumocode/issues/389) |
