...
| 108 | [Preserve child executable provenance](108-preserve-child-executable-provenance.md) | P1 | M | M3 | 095, 097, 101 | TODO | [#402](https://github.com/dhruvkelawala/sumocode/issues/402) |
...
| 107 | [Scale retained transcript/live Activity](107-scale-retained-transcript-and-live-activity.md) | P2 | L | M3 | 103 | DONE — `aee987b5`..`2001f817`; committed Transcript projections now use indexed Activity/delegation folding with one shallow snapshot envelope and bounded target-path copies, while ChatPager retains lightweight virtualized Transcript/feed truth, bounds live render nodes, preserves newest/focused/failed Activities, and rehydrates current state through PageUp/reveal without resetting read state. Evidence: focused 183/183; full unit 2,998/2,998; integration seam 27/27 plus 167/167 and zero-orphan audit; typecheck/build/lint/resume budget/dead-code green; completed-landscape geometry audit clean; full 29-scenario `visual:ci` exit 0 with no canon/golden changes. | [#401](https://github.com/dhruvkelawala/sumocode/issues/401) |
