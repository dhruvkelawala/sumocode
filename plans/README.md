...
|---|---|---|---|---|---|---|---|
| 091 | [Isolate extension-install tests](091-isolate-extension-install-tests.md) | P0 | S | M1 | — | DONE — `6ef8c13`; 29/29 twice, 2,514 unit tests | [#385](https://github.com/dhruvkelawala/sumocode/issues/385) |
