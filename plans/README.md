...
| 102 | [Remediate dependency advisories — sanitized public brief](issues/102.md) | P1 | M | M2 | 101 | DONE locally — local development highs remediated with a pinned Vite dev peer plus narrow PostCSS/Nano ID overrides; nine consumer-runtime findings remain explicitly upstream-blocked with owner and 2026-10-04 expiry; audit policy CLI rejects unclassified, stale, expired, mismatched, local-path, duplicate, and unremediated records and runs in CI; focused 13/13, unit 3,038/3,038, integration 190/190 with zero orphans, supported Pi 0.84.3/0.84.4 matrix, typecheck/build/lint green | [#396](https://github.com/dhruvkelawala/sumocode/issues/396) |
...
| 104 | [Terminal delivery recovery E2E](104-terminal-delivery-end-to-end-recovery.md) | P1 | L | M3 | 092, 093, 100 | READY — Plan 100 completion recorded; reconciled at `9ef92fa1` for deferred index initialization, fail-closed `isIndexReady()` delivery, native regression gates, and generated-artifact policy | [#398](https://github.com/dhruvkelawala/sumocode/issues/398) |
