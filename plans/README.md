...
| 109 | [Contain subagent lifecycle failures](109-contain-subagent-lifecycle-failures.md) | P1 | M | M3 | 095 | DONE — `091cc239`, `e9224d6e`, `71b0dbd7`, `8b774364`; review repairs `d999de12`, `891b6ce4`, `ecd43018`; 149 focused + 2,779 full unit tests; typecheck/build/lint green; integration seam 25/25, full harness incomplete on the pre-existing Plan-116 signal-exit/zero-orphan path (exit 143 after 0 survivors), accepted by operator as a baseline exception | [#403](https://github.com/dhruvkelawala/sumocode/issues/403) |
