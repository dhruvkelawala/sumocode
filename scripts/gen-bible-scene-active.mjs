...
for (const v of [
	...
	{ filename: "scene-activity-cards.html", spec: { ...LANDSCAPE, toolStyle: "activity-cards" } },
	{ filename: "scene-activity-cards-portrait.html", spec: { ...PORTRAIT, toolStyle: "activity-cards" } },
