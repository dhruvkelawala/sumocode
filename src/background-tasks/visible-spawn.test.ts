...
describe("visible-spawn", () => {
	...
	it("buildVisibleAgentCommand routes sumocode through the task subcommand so splash is skipped", () => {
	...
	it("buildVisibleTaskCommand launches pi runner with prompt as kickoff message", () => {
