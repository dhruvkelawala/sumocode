...
# Both calls also print the launcher root the child received, so tests can
# assert the direct-Pi path always names the tree actually loading.
set -euo pipefail
